                    ...
                    @endif
                      <form action="{{route('posts.update',$post)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="body" id="" rows="6" class="form-control" required>{{old('body', $post->body)}}</textarea>
                        </div>
                        <div class="form-group">
                          <label for="title">Contenido embebido</label>
                          <textarea name="iframe" id="" class="form-control">{{old('iframe', $post->iframe)}}</textarea>
                        </div>
                        <div class="form-group">
                          @csrf
                          @method('PUT')
